...
h1 = Plots.density(correct_delta[1, :], legend=false)
Plots.density!(under_delta[1, :], label = "Underestimated gamma")
Plots.vline!([delta_true[2]], label = "True value")
savefig(h1, "../../density_plots/36/delta_density250_1_36.png")
...
savefig(h2, "../../density_plots/36/delta_density250_2_36.png")
