...
density_results = load(datadir("coverage/36/gamma_cov_results100.jld2"))
...
vline!([gamma_true[2]])
savefig(h1, "../density_plots/36/gamma_density100_1.png")

h2 = density(correct_gamma[2, :], legend=false)
density!(under_gamma[2, :])
density!(over_gamma[2, :])
vline!([gamma_true[3]])
savefig(h2, "../density_plots/36/gamma_density100_2.png")
...
savefig(h3, "../density_plots/36/gamma_density100_3.png")
