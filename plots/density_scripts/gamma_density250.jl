...
density_results = load(datadir("coverage/gamma_cov_results250.jld2"))
...
vline!([gamma_true[2]])
savefig(h1, "../density_plots/gamma_density250_1.png")

h2 = density(correct_gamma[2, :], legend=false)
density!(under_gamma[2, :])
density!(over_gamma[2, :])
vline!([gamma_true[3]])
savefig(h2, "../density_plots/gamma_density250_2.png")
...
savefig(h3, "../density_plots/gamma_density250_3.png")
