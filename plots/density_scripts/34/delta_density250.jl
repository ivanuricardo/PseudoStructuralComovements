...
density_results = load(datadir("coverage/34/delta_comparison_results250.jld2"))
...
savefig(h1, "plots/density_plots/34/delta_density250_1.pdf")
...
savefig(h2, "plots/density_plots/34/delta_density250_2.pdf")
...
vline!([delta_true[2]]; linewidth=3)
savefig(r1, "plots/density_plots/34/rrmar_delta_density250_1.pdf")
...
savefig(r2, "plots/density_plots/34/rrmar_delta_density250_2.pdf")
