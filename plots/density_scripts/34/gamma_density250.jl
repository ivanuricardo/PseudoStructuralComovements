...
density_results = load(datadir("coverage/34/gamma_comparison_results250.jld2"))
...
savefig(h1, "plots/density_plots/34/gamma_density250_1.pdf")
...
savefig(h2, "plots/density_plots/34/gamma_density250_2.pdf")
...
StatsPlots.density!(under_gamma[3, :]; linewidth=3)
StatsPlots.density!(over_gamma[3, :]; linewidth=3)
vline!([gamma_true[4]]; linewidth=3)
savefig(h3, "plots/density_plots/34/gamma_density250_3.pdf")
...
vline!([gamma_true[2]]; linewidth=3)
savefig(r1, "plots/density_plots/34/rrmar_gamma_density250_1.pdf")
...
savefig(r2, "plots/density_plots/34/rrmar_gamma_density250_2.pdf")
...
savefig(r3, "plots/density_plots/34/rrmar_gamma_density250_3.pdf")
