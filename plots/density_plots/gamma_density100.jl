...
vline!([gamma_true[2]])
savefig(h1, "gamma_density100_1.png")

h2 = density(correct_gamma[2, :], legend=false)
density!(under_gamma[2, :])
density!(over_gamma[2, :])
vline!([gamma_true[3]])
savefig(h2, "gamma_density100_2.png")

h3 = density(correct_gamma[3, :], label="Correct rank", legendfontsize=10)
...
savefig(h3, "gamma_density100_3.png")
