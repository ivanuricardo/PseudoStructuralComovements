...
function comovement_init(resp, pred, dimvals, ranks; iters=5, tol=1e-07, num_starts=50, num_selected=10, p=1)
...
function main_algorithm(resp, pred, dimvals, ranks; iters=1000, tol=1e-07, num_starts=50, num_selected=10, p=1)
