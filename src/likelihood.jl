...
function comovement_init(resp, pred, dimvals, ranks; iters=5, tol=1e-07, num_starts=60, num_selected=5, p=1)
...
function main_algorithm(resp, pred, dimvals, ranks; iters=1000, tol=1e-07, num_starts=60, num_selected=5, p=1)
...
function comovement_reg(data, dimvals, ranks; iters=1000, tol=1e-07, num_starts=60, num_selected=5, p=1)
